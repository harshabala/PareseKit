...
**Fast path:** [Download the DMG](https://github.com/harshabala/parsekit/releases/latest/download/ParseKit_0.2.9_aarch64.dmg) → open it → drag to Applications → open from Applications.
...
2. Under **Assets**, click **`ParseKit_0.2.9_aarch64.dmg`**.

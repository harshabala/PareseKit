...
<p align="center">
  <a href="https://github.com/harshabala/parsekit/releases/latest/download/ParseKit_0.2.8_aarch64.dmg"><strong>Download for Mac (Apple Silicon)</strong></a>
  &nbsp;·&nbsp;
...
1. [Download the DMG](https://github.com/harshabala/parsekit/releases/latest/download/ParseKit_0.2.8_aarch64.dmg) (macOS 12+, Apple Silicon)
